...
def GoogleSearch(term):
    ...
    oooooo = open('D:\\koro\koro\\Data.txt','a')
    ...
    os.startfile('D:\\koro\\koro\\DataBase\\ExtraPro\\start.py')
...
def Alarm(query):
    ...
    TimeHere=  open('D:\\koro\koro\\Data.txt','a')
    TimeHere.write(query)
    TimeHere.close()
    os.startfile("D:\\koro\\koro\\DataBase\\ExtraPro")

def SpeedTest():

    os.startfile("D:\\koro\\koro\\DataBase\\Gui Programs\\SpeedTestGui.py")
