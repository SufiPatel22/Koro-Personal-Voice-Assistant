...
def GoogleImage():
    oo = open('D:\\koro\\koro\\Data.txt','rt')
    query = str(oo.read())
    oo.close()
    pppp = open('D:\\koro\\koro\\Data.txt','r+')
    pppp.truncate(0)
    pppp.close()

    webdriver = "D:\\koro\\koro\\DataBase\\webdriver\\chromedriver.exe"
    photos = "D:\\koro\\koro\\DataBase\\GooglePhotos\\"
